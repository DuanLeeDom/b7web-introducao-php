...
<body>
    <div class="container">
        <div class="card">
            ...
            <p>Status de Emprego: <strong><?= $esta_empregado == true ? 'Empregado' : 'Desempregrado'; ?></strong></p>
            <p>Anos para Aposentadoria: <strong><?= calcularFaltanteParaAposentadoria($idade, $sexo); ?></strong></p>
